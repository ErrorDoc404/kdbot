...
module.exports = {
    name: "puttparty",
    description: "Starts a puttparty Together session",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'puttparty').then(async invite => {
            let embed = new MessageEmbed()
                .setAuthor({name: "puttparty"})
                .setColor("#FF0000")
                .setDescription(`
                    You can Play puttparty with your friends in a Voice Channel. Click *Join puttparty* to join in!
                    __**[Join puttparty](${invite.code})**__
