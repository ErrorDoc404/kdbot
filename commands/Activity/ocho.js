...
module.exports = {
    name: "ocho",
    description: "Starts a ocho Together session",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'ocho').then(async invite => {
            let embed = new MessageEmbed()
                ...
                .setColor("#FF0000")
                .setDescription(`
                    You can Play ocho with your friends in a Voice Channel. Click *Join ocho* to join in!
                    __**[Join ocho](${invite.code})**__
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            client.discordTogether.createTogetherCode(member.voice.channel.id, 'ocho').then(async invite => {
                let embed = new MessageEmbed()
                    .setAuthor({name: "ocho"})
                    .setColor("#FF0000")
                    .setDescription(`
