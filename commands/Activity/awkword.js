...
module.exports = {
    name: "awkword",
    description: "Starts a awkword Together session",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'awkword').then(async invite => {
            let embed = new MessageEmbed()
                .setAuthor({name: "awkword"})
                .setColor("#FF0000")
                .setDescription(`
                    You can Play awkword with your friends in a Voice Channel. Click *Join awkword* to join in!
                    __**[Join awkword](${invite.code})**__
