...
module.exports = {
    name: "wordsnack",
    description: "Starts a wordsnack Together session",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'wordsnack').then(async invite => {
            let embed = new MessageEmbed()
                .setAuthor({name: "wordsnack"})
                .setColor("#FF0000")
                .setDescription(`
                    You can Play wordsnack with your friends in a Voice Channel. Click *Join wordsnack* to join in!
                    __**[Join wordsnack](${invite.code})**__
