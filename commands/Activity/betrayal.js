...
module.exports = {
    name: "betrayal",
    description: "Starts a betrayal Together session",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'betrayal').then(async invite => {
            let embed = new MessageEmbed()
                ...
                .setColor("#FF0000")
                .setDescription(`
                    You can Play betrayal with your friends in a Voice Channel. Click *Join betrayal* to join in!
                    __**[Join betrayal](${invite.code})**__
