...
module.exports = {
    name: "lettertile",
    description: "Starts a lettertile Together session",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'lettertile').then(async invite => {
            let embed = new MessageEmbed()
                .setAuthor({name: "lettertile"})
                .setColor("#FF0000")
                .setDescription(`
                    You can Play lettertile with your friends in a Voice Channel. Click *Join lettertile* to join in!
                    __**[Join lettertile](${invite.code})**__
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            client.discordTogether.createTogetherCode(member.voice.channel.id, 'lettertile').then(async invite => {
                let embed = new MessageEmbed()
                    .setAuthor({name: "betrayal"})
                    .setColor("#FF0000")
                    .setDescription(`
                        You can Play lettertile with your friends in a Voice Channel. Click *Join lettertile* to join in!
                        __**[Join lettertile](${invite.code})**__
