...
module.exports = {
    name: "sketchheads",
    description: "Starts a sketchheads Together session",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'sketchheads').then(async invite => {
            let embed = new MessageEmbed()
                .setAuthor({name: "sketchheads"})
                .setColor("#FF0000")
                .setDescription(`
                    You can Play sketchheads with your friends in a Voice Channel. Click *Join sketchheads* to join in!
                    __**[Join sketchheads](${invite.code})**__
